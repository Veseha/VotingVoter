...
import votingvoter.Security.event.RegistrationCompleteEvent;
import votingvoter.Security.event.listener.RegistrationCompleteEventListener;
import votingvoter.Security.registration.password.IPasswordResetTokenService;
import votingvoter.Security.registration.token.VerificationToken;
import votingvoter.Security.registration.token.VerificationTokenService;
import votingvoter.Security.user.IUserService;
import votingvoter.Security.utility.UrlUtil;
...
public class RegistrationController {
    ...
    @GetMapping("/forgot-password-request")     //ok
